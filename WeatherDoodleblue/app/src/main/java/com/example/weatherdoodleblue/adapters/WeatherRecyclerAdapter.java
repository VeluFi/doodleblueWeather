package com.example.weatherdoodleblue.adapters;
...
import com.example.weatherdoodleblue.models.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WeatherViewHolder customViewHolder, int i) {
        ...
        Picasso.get()
                .load("http://openweathermap.org/img/wn/" + weatherItem.getIcon() + ".png")
                .resize(50, 50)
                .centerCrop()
                .into(customViewHolder.itemIcon);
