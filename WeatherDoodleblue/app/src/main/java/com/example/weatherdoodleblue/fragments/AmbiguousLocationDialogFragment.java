package com.example.weatherdoodleblue.fragments;
...
import com.example.weatherdoodleblue.activities.MainActivity;
import com.example.weatherdoodleblue.adapters.LocationsRecyclerAdapter;
...
import static com.example.weatherdoodleblue.utils.TimeUtils.isDayTime;
...
public class AmbiguousLocationDialogFragment extends DialogFragment implements LocationsRecyclerAdapter.ItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        @SuppressWarnings("ConstantConditions") final int theme = getTheme(sharedPreferences.getString("theme", "fresh"));
